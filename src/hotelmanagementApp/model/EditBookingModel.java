...
public class EditBookingModel {
    ...
    public EditBookingModel(int selected_id, String name, String emailId, String mobileNumber, String nationality, String address, int no_of_person, int no_of_Days, String roomNo, String roomType, String ac_non_ac, float rate, String idProof, String idName, String arrival_date, String booking_date, String booking_time, String checkin_date, String checkin_time, String checkout_date, String checkout_time, String note) {
